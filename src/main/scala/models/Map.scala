...
object MapID {
  ...
  implicit object Factory extends IDFactory[MapID] {
    val ids = Vector(LevelIntroBat, LevelTrapdoor, LevelLightning, LevelEasy, LevelPoisonLightning,LevelFire,LevelArrowsAndDoors,LevelGambit,LevelBullshit,LevelTiming)
  }
